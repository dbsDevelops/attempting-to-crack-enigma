package mikepound.analysis;

import mikepound.analysis.fitness.FitnessFunction;
import mikepound.enigma.Enigma;
import mikepound.enigma.Plugboard;
...
public class EnigmaAnalysis {
    ...
    public static ScoredEnigmaKey findRingSettings(EnigmaKey key, char[] ciphertext, FitnessFunction f) {
        ...
        int middleRotorIndex = 1;
        int rightRotorIndex = 2;
