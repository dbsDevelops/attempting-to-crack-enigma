                ...
                for (int firstLetter = 0; firstLetter < 26; firstLetter++) {
                    for (int secondLetter = 0; secondLetter < 26; secondLetter++) {
                        for (int thirdLetter = 0; thirdLetter < 26; thirdLetter++) {
                            ...
                            Rotor firstRotor = new Rotor(rotorConfiguration[0], (char) (firstLetter + decimalValueOfFirstAscii));
                            Rotor secondRotor = new Rotor(rotorConfiguration[1], (char) (secondLetter + decimalValueOfFirstAscii));
                            Rotor thirdRotor = new Rotor(rotorConfiguration[2], (char) (thirdLetter + decimalValueOfFirstAscii));

                            Plugboard plugboard = new Plugboard("");

                            Machine enigmaMachine = new Machine(plugboard, firstRotor, secondRotor, thirdRotor, reflector);
...
//TODO: Implement the plugboard finding method